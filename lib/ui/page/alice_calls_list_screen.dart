...
import 'package:flutter_alice_plus/helper/alice_alert_helper.dart';
import 'package:flutter_alice_plus/model/alice_http_call.dart';
import 'package:flutter_alice_plus/model/alice_menu_item.dart';
import 'package:flutter_alice_plus/ui/page/alice_call_details_screen.dart';
import 'package:flutter_alice_plus/ui/page/alice_stats_screen.dart';
import 'package:flutter_alice_plus/ui/utils/alice_constants.dart';
import 'package:flutter_alice_plus/ui/widget/alice_call_list_item_widget.dart';

class AliceCallsListScreen extends StatefulWidget {
  final AliceCore aliceCore;
  const AliceCallsListScreen(this.aliceCore, {super.key});
...
class _AliceCallsListScreenState extends State<AliceCallsListScreen> {
  AliceCore get aliceCore => widget.aliceCore;
  ...
  Widget build(BuildContext context) {
    return Theme(
      data: ThemeData(
        brightness: widget.aliceCore.brightness,
  ...
  void _onListItemClicked(AliceHttpCall call) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder: (context) => AliceCallDetailsScreen(call, widget.aliceCore),
      ),
    );
  }
