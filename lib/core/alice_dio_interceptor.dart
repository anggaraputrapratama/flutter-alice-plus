...
import 'package:flutter_alice_plus/model/alice_form_data_file.dart';
import 'package:flutter_alice_plus/model/alice_from_data_field.dart';
...
class AliceDioInterceptor extends InterceptorsWrapper {
  ...
  void onRequest(
    ...
    AliceHttpCall call = AliceHttpCall(options.hashCode);
